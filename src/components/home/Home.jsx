...
const HomeCard = ({item}) =>{
  ...
  return (
      <Link to={`/seenote/${item._id}`} style={{ backgroundColor: randomColor }} className=' p-5 rounded-[3px] gap-3 w-[260px] h-[180px] text-white hover:text-white relative shadow-md shadow-[#131313]'>
